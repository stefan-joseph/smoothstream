...
The foreground is scoped to the code content; language labels, copy controls,
the frame, and the scrollbar continue to use the surrounding content color.
Application tokens still take precedence when the surrounding design should
own the code surface:
